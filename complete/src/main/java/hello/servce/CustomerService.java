...
public class CustomerService {
    ...
    public List<CustomerDto> getCustomerBySearchKey(String searchKey) {
        List<Customer> customers = customerRepository.findCustomerBy(searchKey);
        CustomerMapper cm = new CustomerMapper();
    ...
    public void updateCustomer(CustomerDto customerDto) {
        CustomerMapper cm = new CustomerMapper();
        customerRepository.update(cm.update(customerDto));
    }
    ...
    public void deleteCustomerByKey(String key) {
        List<Customer> customers = customerRepository.findCustomerBy(key);
        if (customerRepository.findCustomerBy(key.toString()) != null) {
